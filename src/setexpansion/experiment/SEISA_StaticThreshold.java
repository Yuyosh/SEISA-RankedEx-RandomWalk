...
public class SEISA_StaticThreshold
{

	public static Set<String> getExpandedSet(String DataFile, String currentPath, Set<String> seeds, double alpha,
			int resultItemNumber) throws IOException
	{

		SEISA_MapUtility mUtil = new SEISA_MapUtility(DataFile, currentPath);
